    ...
    <>
      <div className={`flex h-20 items-center border-b border-border ${sidebarCollapsed ? "justify-center px-3" : "px-5"}`}>
        ...
        <button
          ...
          aria-label={sidebarCollapsed ? "Expand dashboard navigation" : "Minimize dashboard navigation"}
          title={sidebarCollapsed ? "Expand navigation" : "Minimize navigation"}
        >
      ...
      <div className={`border-t border-border p-4 space-y-1 ${sidebarCollapsed ? "p-2" : ""}`}>
        ...
        >
          <span className={sidebarCollapsed ? "sr-only" : ""}>Return to website</span>
