  ...
  en: {
    ...
    getHelpPage: {
      ...
      form: {
        ...
        successBody: "A healthcare support worker will review what you've shared and get in touch using the contact details you provided.",
  ...
  ro: {
    ...
    getHelpPage: {
      ...
      form: {
        ...
        successBody: "Un lucrător medical de sprijin va analiza ce ai trimis și te va contacta folosind detaliile de contact furnizate.",
  ...
  sq: {
    ...
    getHelpPage: {
      ...
      form: {
        ...
        successBody: "Një punonjës mbështetës shëndetësor do ta shqyrtojë atë që ke ndarë dhe do të të kontaktojë duke përdorur detajet e kontaktit që ke dhënë.",
  ...
  it: {
    ...
    getHelpPage: {
      ...
      form: {
        ...
        successBody: "Un operatore sanitario di supporto esaminerà quanto condiviso e ti contatterà utilizzando i dati di contatto forniti.",
